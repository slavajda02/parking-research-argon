...
def create_questions(device):
    questions = [
        ...
        inquirer.Text('workers', message="How many CPU cores do you want to use for image loading", ignore = is_CPU(device), validate = check_int),
